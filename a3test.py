...
def test_str5_color():
    ...
    text = a3.str5_hsv(introcs.HSV(300.0, .890, 0.89999))
    introcs.assert_equals('(300.0, 0.890, 0.900)', text)
...
def test_cmyk_to_rgb():
    ...
    cmyk = introcs.CMYK(60.784, 21.569, 0.0, 0.0)
    rgb = a3.cmyk_to_rgb(cmyk)
    introcs.assert_equals(100, rgb.red)
    introcs.assert_equals(200, rgb.green)
    introcs.assert_equals(255, rgb.blue)
...
def test_rgb_to_hsv():
    ...
    rgb = introcs.RGB(100, 255, 255)
    hsv = a3.rgb_to_hsv(rgb)
    introcs.assert_equals(180.0 ,round(hsv.hue,3))
...
def test_hsv_to_rgb():
    ...
    hsv = introcs.HSV(300.0, 0.78, 0.89)
    rgb = a3.hsv_to_rgb(hsv)
    introcs.assert_equals(227, rgb.red)
    introcs.assert_equals(50, rgb.green)
    introcs.assert_equals(227, rgb.blue)

    hsv = introcs.HSV(0.0, 0.78, 0.89)
    rgb = a3.hsv_to_rgb(hsv)
    introcs.assert_equals(227, rgb.red)
    introcs.assert_equals(50, rgb.green)
...
def test_contrast_rgb():
    ...
    introcs.assert_equals(127 ,rgb.red)
    introcs.assert_equals(127 ,rgb.red)
    introcs.assert_equals(127 ,rgb.red)
